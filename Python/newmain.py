...
#bad feelings
bfimport = open("./Text Files/Feelings/badfeelings.txt", "r")
badfeelings = bfimport.read()
bfimport.close()

#neutral feelings
nfimport = open("./Text Files/Feelings/neutralfeelings.txt", "r")
...
def giveVIPBot(name):
    if name == "Ancient":
        changeBotName("Roberto")      
    elif name == "Cameron":
        changeBotName("Hank")
    elif name == "Jonas":
        changeBotName("Terrence")
...
def endSubProgram(emotion):
    ...
    returnoption = str(input(f"{name}: ").lower())
...
def chat():
    ...
    while valid == False:
        ...
        if (chatstart == "i love you"):
            ...
            elif (name != "Ancient" and cn == "Roberto"):
                print(f"\n{cn} (*о*) \n{cn} I'm sorry, {name}, I love Ancient!")
                endSubProgram("neutral")
                valid = True
            elif (name != "Ancient" and cn != "Roberto"):
                print(f"\n{cn} I don't know what to say! \n{cn} We've only just met, {name}!")
                endSubProgram("neutral")
        ...
        # i love a girl
            ...
            if (name == "Ancient"):
                ...
                if (dilemma == "yes"):
                    ...
                    print(f"{cn} You scared me, {name}!")
                    endSubProgram("happy")
            elif (name == "Cameron"):
                pass
            else:
                print(f"{cn} I'm happy for you, {name}!")
            ...
            print(f"\n{cn}I'm sorry, {name}, I didn't understand that! Please try again!")
            valid == False        
...
def greet():
    ...
    if feeling in goodfeelings:
        ...
        if (response == "no"):
            print(f"\n{cn} Ok, no problem. \n{cn} Try doing something that makes you happy, or talking to someone that makes you happy")
            endSubProgram("sad")
        elif (response == "yes"):
            pass
        else:
...
def saveFeeling(feeling):
    ...
    if (response == "good"):
        textFileWrite(feeling, "good", gfimport, "./Text Files/Feelings/goodfeelings.txt")
        endSubProgram("happy")
    elif (response == "bad"):
        textFileWrite(feeling, "bad", bfimport, "./Text Files/Feelings/badfeelings.txt")
        endSubProgram("sad")
    elif (response == "neutral"):
        textFileWrite(feeling, "neutral", gfimport, "./Text Files/Feelings/goodfeelings.txt")
        endSubProgram("neutral")
